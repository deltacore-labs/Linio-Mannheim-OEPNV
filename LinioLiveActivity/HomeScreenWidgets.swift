...
struct StandByDepartureWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("widget.standBy.name")
        .description("widget.standBy.description")
...
#Preview("StandBy – mit Fahrt", as: .systemSmall) {
    StandByDepartureWidget()
} timeline: {
    NextDepartureEntry(date: .now, trip: WidgetPreviewData.sampleTrip, isPlaceholder: false)
}

#Preview("StandBy – keine Fahrt", as: .systemSmall) {
    StandByDepartureWidget()
} timeline: {
    NextDepartureEntry(date: .now, trip: nil, isPlaceholder: false)
}
